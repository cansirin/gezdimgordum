...
// NewLandmarkAPIProtobufClient creates a Protobuf client that implements the LandmarkAPI interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewLandmarkAPIProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) LandmarkAPI {
...
func (c *landmarkAPIProtobufClient) GetLandmark(ctx context.Context, in *GetLandmarkRequest) (*Landmark, error) {
	ctx = ctxsetters.WithPackageName(ctx, "gezdimgordum.landmarkapi")
	ctx = ctxsetters.WithServiceName(ctx, "LandmarkAPI")
	ctx = ctxsetters.WithMethodName(ctx, "GetLandmark")
	caller := c.callGetLandmark
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetLandmarkRequest) (*Landmark, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetLandmarkRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetLandmarkRequest) when calling interceptor")
					}
					return c.callGetLandmark(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
...
func (c *landmarkAPIProtobufClient) callGetLandmark(ctx context.Context, in *GetLandmarkRequest) (*Landmark, error) {
	out := new(Landmark)
		...
		caller = func(ctx context.Context, req *DeleteLandmarkRequest) (*google_protobuf.Empty, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*DeleteLandmarkRequest) when calling interceptor")
					}
					return c.callDeleteLandmark(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*google_protobuf.Empty)
...
// NewLandmarkAPIJSONClient creates a JSON client that implements the LandmarkAPI interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewLandmarkAPIJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) LandmarkAPI {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *landmarkAPIJSONClient) GetLandmark(ctx context.Context, in *GetLandmarkRequest) (*Landmark, error) {
	ctx = ctxsetters.WithPackageName(ctx, "gezdimgordum.landmarkapi")
	ctx = ctxsetters.WithServiceName(ctx, "LandmarkAPI")
	ctx = ctxsetters.WithMethodName(ctx, "GetLandmark")
	caller := c.callGetLandmark
...
func (c *landmarkAPIJSONClient) callGetLandmark(ctx context.Context, in *GetLandmarkRequest) (*Landmark, error) {
	out := new(Landmark)
...
// NewLandmarkAPIServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewLandmarkAPIServer(svc LandmarkAPI, opts ...interface{}) TwirpServer {
...
func (s *landmarkAPIServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *landmarkAPIServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// LandmarkAPIPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const LandmarkAPIPathPrefix = "/twirp/gezdimgordum.landmarkapi.LandmarkAPI/"

func (s *landmarkAPIServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "gezdimgordum.landmarkapi")
	ctx = ctxsetters.WithServiceName(ctx, "LandmarkAPI")
	...
	if pkgService != "gezdimgordum.landmarkapi.LandmarkAPI" {
...
func (s *landmarkAPIServer) serveGetLandmark(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveGetLandmarkJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetLandmarkProtobuf(ctx, resp, req)
	default:
...
func (s *landmarkAPIServer) serveGetLandmarkJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetLandmark")
	...
	reqContent := new(GetLandmarkRequest)
	...
	handler := s.LandmarkAPI.GetLandmark
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetLandmarkRequest) (*Landmark, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.LandmarkAPI.GetLandmark(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Landmark)
...
func (s *landmarkAPIServer) serveGetLandmarkProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetLandmark")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *landmarkAPIServer) serveCreateLandmark(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveCreateLandmarkJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveCreateLandmarkProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *landmarkAPIServer) serveCreateLandmarkJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateLandmark")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(CreateLandmarkRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
		...
		handler = func(ctx context.Context, req *CreateLandmarkRequest) (*Landmark, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.LandmarkAPI.CreateLandmark(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Landmark)
...
func (s *landmarkAPIServer) serveCreateLandmarkProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateLandmark")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *landmarkAPIServer) serveDeleteLandmark(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveDeleteLandmarkJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveDeleteLandmarkProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *landmarkAPIServer) serveDeleteLandmarkJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteLandmark")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(DeleteLandmarkRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
		...
		handler = func(ctx context.Context, req *DeleteLandmarkRequest) (*google_protobuf.Empty, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.LandmarkAPI.DeleteLandmark(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*google_protobuf.Empty)
...
func (s *landmarkAPIServer) serveDeleteLandmarkProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteLandmark")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *landmarkAPIServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *landmarkAPIServer) ProtocGenTwirpVersion() string {
	return "v8.1.1"
}
...
func (s *landmarkAPIServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "gezdimgordum.landmarkapi", "LandmarkAPI")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
